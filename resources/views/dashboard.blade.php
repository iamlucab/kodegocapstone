                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span class="mr-2 d-none d-lg-inline text-gray-600 small">Hey, Kodegoer!</span>
...
<?php // include ("footer.php"); ?>
            			...
            			<div class="paymentWrap">
							<div class="btn-group paymentBtnGroup btn-group-justified" data-toggle="buttons">
					            <label class="btn paymentMethod active">
					                ...
					                <input type="radio" id="gcash" name="options " checked> 
					            </label>
					            <label class="btn paymentMethod">
					            	<div class="method paymaya"></div>
					                <input type="radio" id="paymaya" name="options"> 
					            </label>
					            <label class="btn paymentMethod">
				            		<div class="method bdo"></div>
					                <input type="radio" id="bdo" name="options">
					            </label>
					             <label class="btn paymentMethod">
				             		<div class="method palawan"></div>
					                <input type="radio" id="palawan" name="options"> 
					            </label>
  ...
  <input type="text" maxlength="6" class="form-control" aria-label="Amount (to the nearest Peso)">
...
<div class="modal-footer">
 ...
 <!-- Modal Cash Out -->
 <div class="modal fade" id="cash-out" tabindex="-1" role="dialog" aria-labelledby="cash-out"
        aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                <div class="text-xs font-weight-bold text-info text-uppercase mb-1">YOU ARE ABOUT TO CASH OUT </div>
                    <button class="close" type="button" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">×</span>
                    </button>
                </div>
...
<div class="modal-footer">
                    <button class="btn btn-secondary" type="button" data-dismiss="modal">Cancel</button>
                    <a class="btn btn-primary" href="#">Cash Out</a>
                </div>
            </div>
        </div>
    </div>
